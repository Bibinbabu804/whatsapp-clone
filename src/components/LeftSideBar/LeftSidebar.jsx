  ...
  const setChat = async (item) => {
    try {
      ...
      if (chatIndex !== -1) {
        ...
        // Update the chatData state to trigger re-render
        ...
        setChatUser(updatedChatData[chatIndex]); // Ensure the current chatUser is updated in the UI
      }
      setChatVisible(true);
    } catch (error) {
    ...
    <div className={`ls ${chatVisible ? "hidden" : ""}`}>
      <div className='ls-top'>
        <div className='ls-nav'>
          <img width={'130px'} src={assets.logoleft} className='logo' alt="" />
          <div className="menu">
